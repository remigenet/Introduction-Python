...
Afin de vous aider pour réaliser ce TP, vous trouverez une fiche sur l'utilisation de git [ici](../Annexes/git_basics.qmd), ainsi qu'une fiche sur les commandes de base du terminal Linux pour ceux qui n'en ont pas l'habitude [ici](../Annexes/LinuxTerminal.qmd).
