...
Afin de vous aider pour réaliser ce TP, vous trouverez une fiche sur l'utilisation de git [ici](https://remigenet.github.io/website/content/git_basics.html), ainsi qu'une fiche sur les commandes de base du terminal Linux pour ceux qui n'en ont pas l'habitude [ici](https://remigenet.github.io/website/content/LinuxTerminal.html).
